...
--
-- @args iec61850-mms.timeout Time in ms to wait for MMS responses (default: 5000)
--
...
action = function(host, port)
  local timeout = stdnse.parse_timespec(stdnse.get_script_args('iec61850-mms.timeout')) or 5000
